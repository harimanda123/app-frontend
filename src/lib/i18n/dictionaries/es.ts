...
export const es: TranslationKeys = {
  ...
  filingConfig: {
    ...
    tables: {
      ...
      transactionType: {
        label: "Procedimientos Aduaneros",
        description: "Tipos de transacción universales (IMPORT, EXPORT, NCTS, etc.)",
        fields: {
          code: { label: "Código", help: "Código de tipo de transacción - no se puede editar después de la creación" },
          isActive: { label: "Está Activo" },
        },
      },
      actionCatalog: {
        label: "Catálogo de Acciones",
        description: "Códigos de acción universales (SUBMIT, AMENDMENT, CANCELLATION, etc.)",
        fields: {
          code: { label: "Código", help: "Código de acción - no se puede editar después de la creación" },
          isActive: { label: "Está Activo" },
        },
      },
      procedureConfig: {
        label: "Configuración de Procedimiento",
        description: "(country, procedureCode, messageName) - lista mensajes válidos por país/procedimiento",
        fields: {
          country: { label: "País" },
          procedureCode: { label: "Código de Procedimiento" },
          messageName: { label: "Nombre del Mensaje" },
      ...
      actionMessageMapping: {
        label: "Mapeo de Mensaje de Acción",
        description: "(country, procedureCode, action) → messageName - mapea acciones de usuario a mensajes salientes",
        fields: {
          country: { label: "País" },
          procedureCode: { label: "Código de Procedimiento" },
          action: { label: "Acción" },
      ...
      actionConfiguration: {
        label: "Configuración de Acción",
        description: "(country, procedureCode, messageName, status) → availableActions, allowSubmit - determina acciones de UI",
        fields: {
          country: { label: "País" },
          procedureCode: { label: "Código de Procedimiento" },
          messageName: { label: "Nombre del Mensaje" },
          ...
          availableActions: {
            ...
            help: "Lista de acciones disponibles en este estado. Seleccione del Catálogo de Acciones.",
            itemFields: {
              action: { label: "Acción", help: "Seleccione una acción del catálogo" },
            },
          },
          allowSubmit: { label: "Permitir Envío" },
          isActive: { label: "Está Activo" },
        },
      },
      uiConfiguration: {
        label: "Configuración de UI",
        description: "Configurar campos de formulario y diseños para vistas de declaración y respuesta",
        fields: {
          country: { label: "País" },
          procedureCode: { label: "Código de Procedimiento" },
          messageName: { label: "Nombre del Mensaje" },
          messageType: { label: "Tipo de Mensaje", help: "solicitud o respuesta" },
          version: { label: "Versión" },
          description: { label: "Descripción" },
          totalFields: { label: "Campos Totales", help: "Número de campos configurados" },
      ...
      masterDataSource: {
        label: "Fuentes de Datos Maestros",
        description: "Definir fuentes de datos maestros para campos desplegables y de búsqueda",
        fields: {
          sourceName: { label: "Nombre de Fuente", help: "Identificador único (p. ej., País, Moneda)" },
          sourceType: { label: "Tipo de Fuente", help: "tabla, enumeración, api o estático" },
          tableName: { label: "Nombre de Tabla", help: "Nombre del modelo Prisma para fuentes basadas en tablas" },
          valueField: { label: "Campo de Valor", help: "Campo a usar como valor de opción" },
          labelField: { label: "Campo de Etiqueta", help: "Campo a usar como etiqueta de opción" },
          apiEndpoint: { label: "Endpoint de API", help: "Para fuentes basadas en API" },
          apiMethod: { label: "Método de API" },
          isActive: { label: "Activo" },
        },
      },
      countryCustomsVersion: {
        label: "Versiones de Aduanas por País",
        description: "Versiones de aduanas por país y código de procedimiento con períodos de validez",
        fields: {
          country: { label: "Código de País", help: "Código de país ISO (NL, IE, FR, etc.)" },
          procedureCode: { label: "Código de Procedimiento", help: "IMPORT, EXPORT etc." },
          release: { label: "Versión de Lanzamiento", help: "Número de versión (p. ej., 5.28.0)" },
          validFrom: { label: "Válido Desde", help: "Fecha de inicio (YYYY-MM-DD)" },
          validTo: { label: "Válido Hasta", help: "Fecha de fin (YYYY-MM-DD) - opcional" },
          description: { label: "Descripción" },
          isActive: { label: "Activo" },
        },
      },
      customerCustomsVersion: {
        label: "Versiones de Aduanas por Cliente",
        description: "Mapear clientes a versiones de aduanas específicas",
        fields: {
          applyToAllCustomers: { label: "Aplicar a Todos los Clientes", help: "Cuando está marcado, esta versión se aplica a todos los clientes" },
          customerId: { label: "Cliente", help: "Seleccionar cliente específico (dejar vacío si Aplicar a Todos está marcado)" },
          filingCountryCustomsId: { label: "Versión de Aduanas del País", help: "Seleccionar versión de aduanas del país" },
          notes: { label: "Notas" },
          isActive: { label: "Activo" },
        },
      },
